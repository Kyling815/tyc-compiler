...
public class TyCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"STRUCT", "IF", "ELSE", "WHILE", "FOR", "BREAK", "CONTINUE", "RETURN", 
			...
			"DOT", "INT_LIT", "FLOAT_LIT", "EXP", "DIGITS", "STR_CHAR", "ESC_SEQ", 
			"ILLEGAL_ESCAPE", "UNCLOSE_STRING", "STRING_LIT", "ID", "LINE_COMMENT", 
	...
	def emit(self):
	    ...
	    if ttype == self.UNCLOSE_STRING:
	        # text includes the opening quote, remove it
	        raise UncloseString(tk.text[1:])
	    elif ttype == self.ILLEGAL_ESCAPE:
	        # remove opening quote
	        raise IllegalEscape(tk.text[1:])
	    elif ttype == self.ERROR_CHAR:
	        raise ErrorToken(tk.text)
	    else:
	        return tk


	public TyCLexer(CharStream input) {
		super(input);
	...
	public static final String _serializedATN =
		...
		".\u0003.\u014f\b.\u0001.\u0001.\u0003.\u0153\b.\u0001/\u0001/\u0001/\u0005"+
		"/\u0158\b/\n/\f/\u015b\t/\u0001/\u0001/\u0001/\u00010\u00010\u00050\u0162"+
		"\b0\n0\f0\u0165\t0\u00011\u00011\u00011\u00011\u00051\u016b\b1\n1\f1\u016e"+
		"\t1\u00011\u00011\u00012\u00012\u00012\u00012\u00052\u0176\b2\n2\f2\u0179"+
		"\t2\u00012\u00012\u00012\u00012\u00012\u00013\u00043\u0181\b3\u000b3\f"+
		"3\u0182\u00013\u00013\u00014\u00014\u0001\u0177\u00005\u0001\u0001\u0003"+
		"\u0002\u0005\u0003\u0007\u0004\t\u0005\u000b\u0006\r\u0007\u000f\b\u0011"+
		"\t\u0013\n\u0015\u000b\u0017\f\u0019\r\u001b\u000e\u001d\u000f\u001f\u0010"+
		"!\u0011#\u0012%\u0013\'\u0014)\u0015+\u0016-\u0017/\u00181\u00193\u001a"+
		"5\u001b7\u001c9\u001d;\u001e=\u001f? A!C\"E#G$I%K&M\'O(Q)S\u0000U\u0000"+
		"W\u0000Y\u0000[*]+_,a-c.e/g0i1\u0001\u0000\t\u0002\u0000EEee\u0002\u0000"+
		"++--\u0001\u000009\u0004\u0000\n\n\r\r\"\"\\\\\u0007\u0000\"\"\\\\bbf"+
		"fnnrrtt\u0003\u0000AZ__az\u0004\u000009AZ__az\u0002\u0000\n\n\r\r\u0003"+
		"\u0000\t\n\r\r  \u019e\u0000\u0001\u0001\u0000\u0000\u0000\u0000\u0003"+
		"\u0001\u0000\u0000\u0000\u0000\u0005\u0001\u0000\u0000\u0000\u0000\u0007"+
		"\u0001\u0000\u0000\u0000\u0000\t\u0001\u0000\u0000\u0000\u0000\u000b\u0001"+
		"\u0000\u0000\u0000\u0000\r\u0001\u0000\u0000\u0000\u0000\u000f\u0001\u0000"+
